...
/*
 * These types add support for BOOST_FOREACH macro to xml_node and xml_document classes (child
 * iteration only). Example usage: BOOST_FOREACH(xml_node n, doc) {}
 */
...
/*
 * These types add support for BOOST_FOREACH macro to xml_node and xml_document classes
 * (child/attribute iteration). Example usage: BOOST_FOREACH(xml_node n, children(doc)) {}
